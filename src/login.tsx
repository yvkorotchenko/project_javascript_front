...
import { LoginForm as DefaultLoginForm } from 'react-admin';
        ...
        <Root {...rest} ref={containerRef}>
            <Card className={LoginClasses.card}>
                <div className={LoginClasses.avatar}>
                    <Avatar className={LoginClasses.icon} style={{ borderRadius: '50%', width: '140px', height: '140px', background:'#FFFFFF' }}>
                    <img src="./src/images/logo.jpg" alt="Моя картинка" />
                    </Avatar>
                </div>
                {children}
            </Card>
...
const Root = styled('div', {
    ...
    backgroundImage:
        'radial-gradient(circle at 50% 14em, #0d4166 0%, #313264 60%, #313264 100%)',
